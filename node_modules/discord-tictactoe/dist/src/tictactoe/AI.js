                    ...
                    if (i > 0) {
                        ...
                        if (game.board[game.toIndex(j - 1, i)] == player && game.board[game.toIndex(j - 1, i)] == game.board[currentSpot]) {
                            ...
                            //check if below is in bounds and unoccupied
                                ...
                                console.log("bottom, " + currentSpot);
            ...
            for (var i = 1; i < game.boardSize; i++) {
                ...
                if (game.board[game.toIndex(i - 1, i - 1)] == player && game.board[game.toIndex(i - 1, i - 1)] == game.board[currentSpot]) {
                    ...
                    if ((i - 2) >= 0 && game.board[game.toIndex(i - 2, i - 2)] == 0) {
                        console.log("top left, " + currentSpot);
                        cell = game.toIndex(i -2, i - 2);
                    }
                    //check if bottom right is in bounds]
                    if ((i + 1) < game.boardSize && game.board[game.toIndex(i + 1, i + 1)] == 0) {
                        console.log("bottom right, " + currentSpot);
                        cell = game.toIndex(i + 1,i + 1);
                    }
                }

                currentSpot = game.toIndex(game.boardSize - i, game.boardSize - i)
                if (game.board[game.toIndex(game.boardSize - (i - 1), game.boardSize - (i - 1))] == player && game.board[game.toIndex(game.boardSize - (i - 1), game.boardSize - (i - 1))] == game.board[currentSpot]) {
                    console.log("valid");
                    //check if top right is in bounds
                    if ((i - 2) >= 0 && game.board[game.toIndex(game.boardSize - (i - 2), game.boardSize - (i - 2))] == 0) {
                        console.log("top right, " + currentSpot);
                        cell = (i - 2) * (i - 2);
                    }
                    //check if bottom left is in bounds]
                    if ((i + 1) < game.boardSize && game.board[game.toIndex(game.boardSize - (i + 1), game.boardSize - (i + 1))] == 0) {
                        console.log("bottom left, " + currentSpot);
                        cell = game.toIndex(i + 1, i + 1);
                    }
                }
