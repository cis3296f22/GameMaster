...
class AppCommandRegister {
    ...
    /**
     * @method Sends out a message upon deployment of the command
    ...
    /**
     * @method registers the command inside the server being used.
    ...
    /**
     * @method removes the command from the server
