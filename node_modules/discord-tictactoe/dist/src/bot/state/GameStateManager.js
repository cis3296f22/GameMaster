...
const Board = __importDefault(require("../entity/GameBoard"));
    ...
    createGame(tunnel, invited) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.validator.isInteractionValid(tunnel)) {
                ...
                const gameboard = new Board.default(this, tunnel, invited !== null && invited !== void 0 ? invited : new AI.default(), this.bot.configuration);
