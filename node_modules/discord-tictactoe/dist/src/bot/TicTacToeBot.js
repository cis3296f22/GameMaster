    ...
    attachToClient(client) {
        const onReady = () => {
            ...
            if (client.application && this.configuration.command) {
                const register = new AppCommandRegister.default(client.application.commands, this.configuration.command, (_a = this.configuration.commandOptionName) !== null && _a !== void 0 ? _a : 'opponent');
